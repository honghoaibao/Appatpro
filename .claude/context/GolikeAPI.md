...
| `data.coin` | int | Số coin hiện tại |
...
| Field | Type | Mô tả |
|---|---|---|
| `current_coin` | int | Tổng coin hiện tại của user |
| `<platform>.hold_coin` | int | Coin đang giữ (chưa quyết toán) |
| `<platform>.pending_coin` | int | Coin đang chờ duyệt |
...
*Phiên bản: 1.0 – Ngày tạo: 2026-06-01*
