...
object OverlayFarmMonitor {
    ...
    private var bubbleWidthPx:  Int = 0   // v1.2.7: minimize wrapper width
    private var bubbleHeightPx: Int = 0   // v1.2.7: minimize wrapper height (circle + bubble)
    ...
    private fun buildView(context: Context): View {
        ...
        panelWidthPx   = dp(220)
        circleSizePx   = dp(52)
        bubbleWidthPx  = dp(170)              // v1.2.7
        bubbleHeightPx = circleSizePx + dp(80)  // v1.2.7
    ...
    private fun onMinimizeClick() {
        handler.post {
            ...
            if (isMinimized) {
                ...
                // v1.2.7: dùng field đã tính sẵn (dp() chỉ available trong buildView)
