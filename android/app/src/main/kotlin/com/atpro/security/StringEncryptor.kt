...
object AppConstants {
     ...
     * v1.3.3: Bật lại — đưa Golike TikTok trở lại cho người dùng. Task state
     * machine (runTaskStateMachine/taskOneAccount trong AutomationEngine.kt)
     * đã tồn tại từ v1.2.1 và được bổ sung nuôi acc ngắn/dài + delay người
     * thật ở bản này — xem `.claude/revision/v1.3.3.md`.
     */
    const val GOLIKE_ENABLED = true
